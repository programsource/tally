...
import com.cocoon.jay.tallybook.activity.MainActivity;
        ...
        public void onClick(View view) {
            ...
            if (mDatas.get(getAdapterPosition()).getSort_id().equals("0")) {//添加按钮
                ...
                if (lastClickItem != null) {
                    Log.d(TAG, "last click in");
                    lastClickItem.setTextSize(13);
                    lastClickItem.setTextColor(Color.BLACK);
                }
                title.setTextSize(18);
                title.setTextColor(Color.parseColor("#FF5050"));
                lastClickItem = title;
                TallyBookNoteActivity.setCategory(title.getText().toString());
            }
        }
